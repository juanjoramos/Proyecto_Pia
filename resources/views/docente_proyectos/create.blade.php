<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-white leading-tight">Asignar Docente a Proyecto</h2>
    ...
    <div class="py-12 px-6 flex justify-center bg-gray-900">
        <form action="{{ route('docente_proyectos.store') }}" method="POST"
              class="bg-gray-800 w-full max-w-2xl p-8 rounded-2xl shadow-lg text-white">
            @csrf

            <h3 class="text-2xl font-bold mb-6 border-b border-gray-700 pb-2">Asignar Docente a Proyecto</h3>
